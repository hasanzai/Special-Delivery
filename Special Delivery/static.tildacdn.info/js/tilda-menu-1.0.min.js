function t_menu__highlightActiveLinks(e) {
    ...
    Array.prototype.forEach.call(i, (function(e) {
        ...
        if (i) {
            var o = e.href,
                a = "/" === i[0] ? i.slice(1) : i,
                l; - 1 !== r.indexOf("tpost") && (l = "/" + r.slice(0, r.indexOf("tpost"))), o !== t && o !== r && i !== t && i !== r && a !== r && n !== t && n !== r && i !== l || e.classList.add("t-active")
        }
    }))
}
...
function t_menu__interactFromKeyboard(e) {
    ...
    if (t) {
        var n = t.querySelectorAll(".t-menu__list > li > a"),
            ...
            l = 32,
            s = 0,
            u, t_menu__focusOnCurrentMenuItem = function(e) {
            ...
            t_menu__interactWithMenuFromKeyboard = function(e) {
                e.addEventListener("keydown", (function(e) {
                    ...
                    switch (e.keyCode) {
                        case i:
                            if (!e.shiftKey && s <= n.length - 2) t_menu__focusOnCurrentMenuItem(s + 1);
                            else {
                        ...
                        case l:
                            if (!t) return;
                            this.click(), u = 0, t_menu__focusOnCurrentSubmenuItem(t, 0)
                    }
                    e.preventDefault()
                }))
            },
                ...
                e.addEventListener("keydown", (function(e) {
                    ...
                    switch (e.keyCode) {
                        case i:
                            ...
                            if (e.shiftKey) 0 === u ? (t_menu__focusOnCurrentMenuItem(s), t_menusub__hideSubmenu(t)) : t_menu__focusOnCurrentSubmenuItem(c, u - 1);
                            else if (u === d - 1) {
                                if (t_menusub__hideSubmenu(t), s === n.length - 1) return;
                                t_menu__focusOnCurrentMenuItem(s + 1)
                            } else t_menu__focusOnCurrentSubmenuItem(c, u + 1);
                            break;
                        case o:
                        case l:
                            ...
                            break;
                        case a:
                            r = !0, t_menu__focusOnCurrentMenuItem(s), t_menusub__hideSubmenu(t)
                    }
        ...
        Array.prototype.forEach.call(n, (function(e) {
            var t;
            t_menu__focusOnMenuItem(e), t_menu__interactWithMenuFromKeyboard(e), !e.parentNode.querySelector(".t-menusub__menu") || window.isMobile || "ontouchend" in document || t_menu__clickOnMenuItem(e)
