function t_cover__parallax(e) {
    ...
    var o = t_cover__getFullHeight(e),
        r = .2,
        n;
...
function cover_init(e) {
    ...
    if (n) {
        ...
        (window.t_cover__isMobile || "ontouchend" in document) && l && !o && (n.style.backgroundImage = 'url("' + c["cover-bg"] + '")'), setTimeout((function() {
        ...
        })), t_cover__setListenerToArrow(e), t_cover__setCoverParams(n, c, l), n.addEventListener("displayChanged", (function() {
            t_cover__recalcContentHeight(e, !1, 0)
        }))
    }
}
...
function t_cover__setCoverParams(e, t, o) {
    var r = "fixed" === t["cover-parallax"],
        n = "dynamic" === t["cover-parallax"],
        i = "yes" === t["bg-base64"],
        c;
    if (t["parent-bg"]) {
    ...
    if (i && t["cover-bg"] && !o) {
        ...
        l.src = t["cover-bg"], l.onload = function() {
            l.parentElement && l.parentElement.removeChild(l), e.style.backgroundImage = 'url("' + t["cover-bg"] + '")', e.style.opacity = "1", u = !0
...
function t_cover__setCoverVideoParams(e, t, o, r) {
    var n = "";
    if (t["video-url-youtube"] && (n = "youtube"), (t["video-url-vimeo"] || t["video-url-rutube"] || t["video-url-kinescope"] || t["video-url-vkvideo"]) && (n = "iframe"), !window.t_cover__isMobile && !("ontouchend" in document) && o) switch (t_cover__setStylesForCoverVideo(e, "youtube" === n ? "youtube" : ""), n) {
        case "youtube":
...
function t_cover__processHTML5Video(e, t, o) {
    ...
    var r, n = !!(-1 !== t["cover-height"].indexOf("vh")) && parseInt(t["cover-height"], 10) > 100,
        i, c = !!(-1 !== t["cover-height"].indexOf("px")) && parseInt(t["cover-height"], 10) > window.innerHeight,
        a = !1;
    o && (n || c) && (e.style.height = "100vh", a = !0);
    var d = !t["video-noloop"],
        _ = !t["video-nomute"],
        u;
    "IntersectionObserver" in window ? new IntersectionObserver((function(e, o) {
        e.forEach((function(e) {
    ...
    window.addEventListener("scroll", (function() {
        if (o && a) {
            var t = e.parentElement,
                ...
                n, i = r + window.innerHeight,
                c = t_cover__getPureHeight(t),
                d = t.getBoundingClientRect().top + r,
                _;
...
function t_cover__createYoutubeCover(e, t) {
    if (!e.querySelector("iframe")) {
        var o = window.pageYOffset,
            ...
            n = t_cover__getPureHeight(e),
            i = e.getBoundingClientRect().top + o,
            c, a, d = 500;
...
function t_cover__createHTMLVideoCover(e, t, o, r, n, i) {
    if (!e.querySelector("video")) {
        var c = window.pageYOffset,
            ...
            d = t_cover__getPureHeight(e),
            _ = e.getBoundingClientRect().top + c,
            u, l, v = 500;
...
function t_cover__setRecalculatedHeight(e, t) {
    ...
    (a || e.querySelector(".t734")) && v.push(".t-slds__items-wrapper"), v.forEach((function(t) {
        var o;
        Array.prototype.slice.call(e.querySelectorAll(t)).forEach((function(e) {
            c && e && e.classList.contains("t-cover__carrier") && u < document.documentElement.clientHeight ? (l = .2 * document.documentElement.clientHeight, e.style.height = u + l + "px") : e && (e.style.height = u + "px")
        }))
