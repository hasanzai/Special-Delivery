...
function t_outerWidth(t) {
    var e = getComputedStyle(t),
        ...
        i = e.marginLeft,
        o = e.marginRight;
    return "auto" === n && (n = 0), "auto" === i && (i = 0), "auto" === o && (o = 0), n = parseInt(n) + parseInt(i) + parseInt(o)
}
var version, version;
    ...
    return e || (e = 250),
        function() {
            var r = n || this,
                a = +new Date,
                l = arguments;
            i && a < i + e ? (clearTimeout(o), o = setTimeout((function() {
                i = a, t.apply(r, l)
            }), e)) : (i = a, t.apply(r, l))
        }
}
...
function t_onFuncLoad(t, e, n) {
    ...
    if (a(t) && r()) e();
        ...
        setTimeout((function o() {
            var d = Date.now();
            a(t) && r() ? e() : ("complete" === document.readyState && d - l > i && !a(t) && s(), setTimeout(o, n || 100))
        }))
    }
}
...
function t_scrollBarWidthCompensator__setObject() {
    ...
    })), t.fixedElements = [], Array.prototype.forEach.call(n, (function(e) {
...
function t_scrollBarWidthCompensator__init() {
    if (!window.isMobile) {
        ...
        if (t.scrollBarWidth = Math.abs(window.innerWidth - document.documentElement.clientWidth), t.cancelTimeout && (window.clearTimeout(t.cancelTimeout), t.cancelTimeout = null), !t.isInited && t.scrollBarWidth) {
            ...
            n && document.body.setAttribute("data-tilda-initial-padding-right", n), document.body.style.paddingRight = t.scrollBarWidth + e + "px", document.body.style.height = "100vh", document.body.style.minHeight = "100vh", document.body.style.overflow = "hidden";
            var i = [];
            Array.prototype.forEach.call(t.fixedElements, (function(e) {
                ...
                if (document.body.contains(n) && !n.classList.contains("t975") && !n.classList.contains("t975")) {
                    ...
                    if ("fixed" === r || "absolute" === r) {
                        ...
                        a.indexOf("ms") + 1 ? (a = parseInt(a.replace("ms", ""), 10), i.push(a)) : a.indexOf("s") + 1 && (a = 1e3 * parseFloat(a.replace("s", "")), i.push(a));
                        ...
                        var h = "100%" === d || d === window.innerWidth + "px" || d === window.innerWidth - t.scrollBarWidth + "px" || "100vw" === d,
                            p = "100%" === s || s === window.innerHeight + "px" || s === window.innerHeight - t.scrollBarWidth + "px" || "auto" === s || "100vh" === s;
                        !l && 0 !== l || "auto" === n.style.right || "absolute" === r || h ? h && !p && (n.style.width = "calc(100vw - " + t.scrollBarWidth + "px)") : n.style.right = t.scrollBarWidth + l + "px"
                    }
                }
...
function t_scrollBarWidthCompensator__cancel() {
    ...
    t && t.isInited && (t.isInited = !1, t.delay = 0, document.body.hasAttribute("data-tilda-initial-padding-right") ? (document.body.style.paddingRight = document.body.getAttribute("data-tilda-initial-padding-right"), document.body.removeAttribute("data-tilda-initial-padding-right")) : document.body.style.removeProperty("padding-right"), document.body.style.removeProperty("height"), document.body.style.removeProperty("min-height"), document.body.style.removeProperty("overflow"), Array.prototype.forEach.call(t.fixedElements, (function(t) {
        ...
        e.hasAttribute("data-tilda-initial-right") ? (e.style.right = e.getAttribute("data-tilda-initial-right"), e.removeAttribute("data-tilda-initial-right")) : e.style.removeProperty("right"), e.hasAttribute("data-tilda-initial-width") ? (e.style.width = e.getAttribute("data-tilda-initial-width"), e.removeAttribute("data-tilda-initial-width")) : (e.style.removeProperty("width"), n && (e.style.width = "inherit"))
    })))
}

function t_triggerEvent(t, e) {
    var n;
    document.createEvent ? (n = document.createEvent("HTMLEvents")).initEvent(e, !0, !1) : document.createEventObject && ((n = document.createEventObject()).eventType = e), n.eventName = e, t.dispatchEvent ? t.dispatchEvent(n) : t.fireEvent ? t.fireEvent("on" + n.eventType, n) : t[e] ? t[e]() : t["on" + e] && t["on" + e]()
}
...
function t_loadJsFile(t, e) {
    if (document.querySelector('script[src^="' + t + '"]')) e && e();
        ...
        n.type = "text/javascript", n.src = t, e && (n.onload = e), n.onerror = function(t) {
...
function t_loadCSSFile(t, e) {
    if (document.querySelector('link[href^="' + t + '"]')) e && e();
        ...
        n.rel = "stylesheet", n.type = "text/css", n.media = "all", n.href = t, e && (n.onload = e), n.onerror = function(t) {
...
window.browserLang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.tildaBrowserLang = window.browserLang, t_onReady((function() {
        ...
        if (!window.isMobile && t && "yes" !== t.getAttribute("data-blocks-animationoff") && !1 === window.isSearchBot) {
            ...
            for (var r = Array.prototype.slice.call(e).filter((function(t) {
                ...
                var i, a = (i = r[n]).getBoundingClientRect().top + window.pageYOffset,
                    l = window.pageYOffset + window.innerHeight + 300;
                t_addClass(i, a > 1e3 && a > l ? "r_hidden" : "r_showed"), t_addClass(i, "r_anim")
            }
            if (r.length) {
                function d() {
                    for (var t = r.length - 1; t >= 0; t--) {
                        var e = r[t],
                            n, i = 0;
                        e.getBoundingClientRect().top + window.pageYOffset < (i = e.offsetHeight <= 100 ? window.pageYOffset + window.innerHeight : window.pageYOffset + window.innerHeight - 100) && (t_removeClass(e, "r_hidden"), t_addClass(e, "r_showed"), (r = Array.prototype.slice.call(r)).splice(t, 1))
                    }
                }
                var s = document.querySelectorAll('[data-record-type="400"]');
                if (s.length > 0) var c = 0,
                    u = 0,
        ...
        var g = document.querySelector(".t-tildalabel"),
            w;
        (w = m ? Math.max(m.scrollHeight, m.offsetHeight, m.clientHeight, p.offsetHeight) : p.offsetHeight) + 70 < window.innerHeight ? g && (g.style.display = "none") : g && g.setAttribute("style", "display: block !important")
    })),
    function() {
        function t() {
        ...
        function e() {
            var t = window.isMobile ? document.documentElement.clientWidth : window.innerWidth,
                ...
                n, i, o; - 1 !== navigator.userAgent.indexOf("Instagram") && (t = screen.width);
            for (var r = 0; r < e.length; r++) {
                var a = e[r];
                if ("yes" === a.getAttribute("data-connect-with-tab")) return;
                o = getComputedStyle(a).display, (n = a.getAttribute("data-screen-max")) || (n = 1e4), (i = a.getAttribute("data-screen-min")) || (i = 0), n = parseInt(n), (i = parseInt(i)) <= n && (t <= n && t > i ? "block" !== o && (a.style.display = "block") : "none" !== o && (a.style.display = "none"))
            }
        }
        t_onReady((function() {
    ...
    function() {
        ...
        function e() {
            ...
            for (var n = 0; n < h.length; n++) {
                var i, o;
                (o = (i = h[n]).style).height.indexOf("vh") > -1 && (e = parseInt(o.height) / 100, d = p + "px", o.height = d)
            }
        }
            ...
            for (var l = 0; l < i.length; l++)
                for (var d = i[l], s = d.querySelectorAll('div:not([data-auto-correct-mobile-width="false"]):not(.tn-elem):not(.tn-atom):not(.tn-atom__sbs-anim-wrapper):not(.tn-atom__prx-wrapper):not(.tn-atom__videoiframe):not(.tn-atom__sticky-wrapper):not(.t-store__relevants__container):not(.t-slds__items-wrapper):not(.js-product-controls-wrapper):not(.js-product-edition-option):not(.t-product__option-variants)'), c = 0; c < s.length; c++) {
                    ...
                    if (h > e) {
                        ...
                        console.log("Block not optimized for mobile width. Block width:" + h + " Block id:" + d.getAttribute("id")), console.log(u), d.style.overflow = "auto", d.style.wordBreak = h - 3 > e ? "break-word" : ""
                    }
                }
        }
        ...
        function i(t) {
            for (var e = document.querySelectorAll('.t-text:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-name:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-title:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-descr:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-heading:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-text-impact:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-subtitle:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-uptitle:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"])'), n = 0; n < e.length; n++) {
                ...
                if (o) {
                    var r = "rem" === i.getAttribute("data-auto-correct-font-size"),
                        a;
                    if (document.documentElement.clientWidth > t) a = (a = o.replace("lineheight", "line-height")).replace("fontsize", "font-size"), i.setAttribute("style", a);
                    else {
                        if (-1 === o.indexOf("font-size")) continue;
                        if (parseInt(getComputedStyle(i).fontSize.replace("px", "")) < 26) continue;
                        a = o.replace("line-height", "lineheight"), a = r ? a.replace(/font-size.*px;/gi, "font-size: 1.6rem;") : a.replace("font-size", "fontsize"), i.setAttribute("style", a)
                    }
                }
            }
            ...
            i(480), window.addEventListener("orientationchange", (function() {
                setTimeout((function() {
                    i(480)
                }), 500)
            }))
        })), window.addEventListener("load", n), window.addEventListener("orientationchange", (function() {
            setTimeout((function() {
                n()
            }), 500)
            ...
            for (var t = document.querySelectorAll('[data-customstyle="yes"]'), e = document.querySelectorAll("[field] span, [field] strong, [field] em, [field] a"), n = 0; n < t.length; n++) {
                var i = t[n];
                parseInt(getComputedStyle(i).fontSize.replace("px", "")) > 30 && (i.style.fontSize = null, i.style.lineHeight = null)
            }
            for (var n = 0; n < e.length; n++) {
                var i = e[n];
    ...
    function(t, e) {
        ...
        document.body.addEventListener("popupShowed", t_scrollBarWidthCompensator__init), document.body.addEventListener("popupHidden", (function() {
            var t = window.scrollBarWidthCompensator;
            t && (t.cancelTimeout && (window.clearTimeout(t.cancelTimeout), t.cancelTimeout = null), t.cancelTimeout = window.setTimeout((function() {
